package com.example.solidplanner.ViewHolder;
...
public class ViewHolder_Nota extends RecyclerView.ViewHolder {
    ...
    public void SetearDatos(Context context, String id_nota , String uid_usuario,  String correo_usuario,
                            ...
                            String estado, String hora, String horaF){

        //DECLARAR LAS VISTAS
        TextView Id_nota_Item, Uid_Usuario_Item, Correo_usuario_Item,Fecha_hora_registro_Item,Titulo_Item,
                Descripcion_Item, Fecha_Item, Estado_Item, Hora_Item, Hora_Fin_Item;
        ...
        Hora_Fin_Item = mView.findViewById(R.id.Hora_Fin_Item);
        ...
        Hora_Item.setText(hora);
        Hora_Fin_Item.setText(horaF);
