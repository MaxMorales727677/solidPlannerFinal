package com.example.solidplanner.Notas;
...
public class Actualizar_Nota extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView Id_nota_A, Uid_Usuario_A, Correo_usuario_A, Fecha_registro_A , Fecha_A, Hora_A, Hora_Fin_A, Estado_A, Estado_nuevo;
    EditText Titulo_A, Descripcion_A;
    Button Btn_Calendario_A, Btn_Hora_A, Btn_Hora_Fin_A;

    //DECLARAR LOS STRING PARA ALMACENAR LOS DATOS RECUPERADOS DE ACTIVIDAD ANTERIOR
    String id_nota_R , uid_usuario_R , correo_usuario_R, fecha_registro_R, titulo_R, descripcion_R, fecha_R, Hora_R, Hora_Fin_R, estado_R;

    ImageView Tarea_Finalizada, Tarea_No_Finalizada;

    Spinner Spinner_estado;
    int dia, mes , anio, hora, minutos, horaF, minutosF;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Actualizar evento");
        ...
        Btn_Hora_Fin_A.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SeleccionarHoraFinA();
            }
    ...
    private void InicializarVistas(){
        ...
        Hora_Fin_A = findViewById(R.id.Hora_Fin_A);
        ...
        Btn_Hora_Fin_A = findViewById(R.id.Btn_Hora_Fin_A);
    ...
    private void RecuperarDatos(){
        ...
        Hora_R = intent.getString("hora_inicio");
        Hora_Fin_R = intent.getString("hora_fin");
    ...
    private void SeleccionarHoraA(){
        final Calendar HH = Calendar.getInstance();

        hora=HH.get(Calendar.HOUR_OF_DAY);
        minutos=HH.get(Calendar.MINUTE);
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(Actualizar_Nota.this, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int HoraS, int MinutoS) {
                ...
                HoraFormateada = String.valueOf(HoraS);
                MinutoFormateado = String.valueOf(MinutoS);

                //Setear fecha en TextView
                Hora_A.setText(HoraFormateada+":"+MinutoFormateado);
            }
            }
            ,hora, minutos, true);
    ...
    private void SeleccionarHoraFinA(){
        final Calendar HHF = Calendar.getInstance();

        horaF=HHF.get(Calendar.HOUR_OF_DAY);
        minutosF=HHF.get(Calendar.MINUTE);
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(Actualizar_Nota.this, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int HoraS, int MinutoS) {
                ...
                //Setear fecha en TextView
                Hora_Fin_A.setText(HoraFormateada+":"+MinutoFormateado);
            }
        }
                ,horaF, minutosF, true);
        timePickerDialog.show();
    ...
    private void ActualizarNotaBD(){
        ...
        String horaFinActualizar = Hora_Fin_A.getText().toString();
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds : snapshot.getChildren()){
                    ...
                    ds.getRef().child("hora").setValue(horaActualizar);
                    ds.getRef().child("horaF").setValue(horaFinActualizar);
