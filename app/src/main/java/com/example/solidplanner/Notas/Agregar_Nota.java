...
public class Agregar_Nota extends AppCompatActivity {
    ...
    TextView Uid_Usuario, Correo_usuario, Fecha_hora_actual, Fecha, Estado, Hora, Hora_Fin;
    EditText Titulo, Descripcion;
    Button Btn_Calendario, Btn_Hora, Btn_Hora_Fin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btn_Hora_Fin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Agregar_Nota.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int HoraSF, int MinutoSF) {

                        String HoraFormateadaF, MinutoFormateadoF;
                        HoraFormateadaF = String.valueOf(HoraSF);
                        MinutoFormateadoF = String.valueOf(MinutoSF);

                        //Setear fecha en TextView
                        Hora_Fin.setText(HoraFormateadaF+":"+MinutoFormateadoF);
                    }
                }
                        ,horaF, minutosF, true);
                timePickerDialog.show();
    ...
    private void InicializarVariables(){
        ...
        Btn_Hora_Fin = findViewById(R.id.Btn_Hora_Fin);

        BD_Firebase = FirebaseDatabase.getInstance().getReference("Notas_Publicadas");
    ...
    private void Agregar_Nota(){
        ...
        String horaF = Hora_Fin.getText().toString();

        //Validar datos
        if (!uid_usuario.equals("") && !correo_usuario.equals("") && !fecha_hora_actual.equals("") &&
                !titulo.equals("") && !descripcion.equals("") && ! fecha.equals("") && !estado.equals("") && !hora.equals("") && !horaF.equals("")){
